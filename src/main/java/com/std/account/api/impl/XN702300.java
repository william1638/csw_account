...
import com.std.account.dto.req.XN702300Req;
 ...
 * @history:
 */
public class XN702300 extends AProcessor {
    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN702300Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN702300Req.class);
