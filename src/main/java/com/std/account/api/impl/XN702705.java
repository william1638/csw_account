...
import com.std.account.dto.req.XN702705Req;
...
public class XN702705 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN702705Req.class);
