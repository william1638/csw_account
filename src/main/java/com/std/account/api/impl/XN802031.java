...
import com.std.account.dto.req.XN802031Req;
...
public class XN802031 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN802031Req.class);
