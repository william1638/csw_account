...
import com.std.account.dto.req.XN702707Req;
...
public class XN702707 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN702707Req.class);
