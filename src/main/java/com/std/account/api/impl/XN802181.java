...
import com.std.account.dto.req.XN802181Req;
...
public class XN802181 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        return weChatAO.doCallbackAPP(req.getResult());
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN802181Req.class);
