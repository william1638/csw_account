...
import com.std.account.dto.req.XN802223Req;
 ...
 * @history:
 */
public class XN802223 extends AProcessor {
    private IWithdrawAO withdrawAO = SpringContextHolder
        .getBean(IWithdrawAO.class);

    private XN802223Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN802223Req.class);
